...
<html>
    <head>      
          <script>            
            function validateForm() {
                ...
                var e = document.forms["myform"]["description"].value;
    ...
    <body >
       ...
       <center>
            ...
            <div id="log1">
              <form  name="form" id="myform" action="updateForm.php?id='$ID'" onsubmit="return validateForm()" method="post" enctype="multipart/form-data">
              <table>
                <tr colspan=2>
                    <p style="color:white"> Update Item  </p> 
                ...
                <tr>
                     <?php
                        ...
                        {
                             echo '<a href="update.php?id='.$row["ID"].'" ><img id="v" src="data:image/jpeg;base64,'.base64_encode( $row['Image'] ).'" height="100px" width="100px"/></a>&nbsp;';
                        }
                ...
                <tr>
                    ...
                    <td>
                        <textarea id="name" name="name" form="myform" rows="2" cols="40" style="font-size:12">&nbsp;&nbsp;&nbsp;'.$row["Name"].'</textarea>
                    </td>
                    <td>
                ...
                <tr>
                  ...
                  <tr align="center" >
                        <td colspan=4>
                            <input style="width:300px;font-size: 14px; font-family: Times, Times New Roman, serif" onclick="validate()" href="CLlogin.html" type="submit" value="Update Item"><br/>
                         </td>  
                  </tr>';?>
                </table>  
              </form>
