    ...
    <body >
       ...
       <center>
            ...
            <table cellspacing="40" align="left" width=100% height=100% padding="0px" rowspan= 0; colspan=0>
                ...
                <tr>
                    <td>
                     <form action="adminVUsers.php">
                        <button id="getStarted1"><img src="view.png" align="middle" alt="facebook logo" width="100" height="100" style=" z-index: 1000; right:0" >
                                    View Users List</button>
                     </form>
                    </td>
                    <td>
                     <form action="adminVStocks.php">
                        <button id="getStarted1"><img src="view.png" align="middle" alt="facebook logo" width="100" height="100" style=" z-index: 1000; right:0" >View Stocks</button>
                     </form>
                    </td>
                </tr>
                 ...
                 <tr>
                    <td>
                     <form action="RemoveUser.php">
                        <button id="getStarted1"><img src="delete.png" align="middle" alt="facebook logo" width="100" height="100" style=" z-index: 1000; right:0" >Remove Users</button>
                     </form>
                    </td>
                    <td>
                     <form action="adminRStock.php">
                        <button id="getStarted1"><img src="delete.png" align="middle" alt="facebook logo" width="100" height="100" style=" z-index: 1000; right:0" >Remove Stocks</button>
                     </form>
                    </td>
                </tr>
           </table>
