...
<html>
    ...
    <body >
       ...
       <center>
            ...
            <div id="log1">
              <form  name="form" id="myform" action="deleteItem.php" onsubmit="return validateForm()" method="post" enctype="multipart/form-data" >
              <table>
                <tr colspan=2>
                ...
                <tr>
                     <?php
                        ...
                        {
                             echo '<a href="delete.php?id='.$row["ID"].'" ><img id="v" src="data:image/jpeg;base64,'.base64_encode( $row['Image'] ).'" height="100px" width="100px"/></a>&nbsp;';
                        }
                ...
                <tr>
                    ...
                    <td>
                         <textarea readonly name="name" form="myform" rows="2" cols="40" style="font-size:12">&nbsp;&nbsp;&nbsp;'.$row["Name"].'</textarea>
                    </td>
                    <td>
                    ...
                    <td rowspan=2>
                       ...
                       <textarea readonly name="description" form="myform" rows="8" cols="60" style="font-size:12">'.$row["Description"].'</textarea>
                ...
                <tr>
                    ...
                    <td>
                          <input readonly style="font-size: 12px; width:300px; font-family: Times, Times New Roman, serif" type="text" id="price" name="price" Value='.$row["Price"].'><br/>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                         <input readonly style="font-size: 12px; width:300px; font-family: Times, Times New Roman, serif" type="text" id="features" name="features" Value='.$row["Features"].'><br/>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                      <input readonly style="font-size: 12px; width:300px; font-family: Times, Times New Roman, serif" type="text" id="quantity" name="quantity"  Value='.$row["Quantity"].'><br/>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <select readonly style="width:300px;font-size: 12px; font-family: Times, Times New Roman, serif" id="category" name="category" >
