    ...
    <body>
                ...
                <ul class="menu">
                    ...
                    <li id = "TNav"><a href="#AboutUs">Categories <i class="fa fa-caret-down"></i> </a>
                        <ul class="submenu">
                            ...
                            <li> <a onclick='<?php $cat = "community"; ?>' href="sampleCat.php?cat=community">Community</a> </li>
                            <li> <a onclick='<?php $cat = "Housing"; ?>'   href="sampleCat.php?cat=housing">Housing</a> </li>
                            <li> <a onclick='<?php $cat = "Jobs"; ?>'      href="sampleCat.php?cat=jobs">Jobs</a> </li>
                            <li> <a onclick='<?php $cat = "Services"; ?>'  href="sampleCat.php?cat=services">Services</a> </li>
                            <li> <a onclick='<?php $cat = "For Sale"; ?>'  href="sampleCat.php?cat=sale">For Sale</a> </li>
                            <li> <a onclick='<?php $cat = "Discussion Forum"; ?>'href="sampleCat.php?cat=discussion">Discussion Forum</a> </li>
                            <li> <a onclick='<?php $cat = "Gigs"; ?>'      href="sampleCat.php?cat=gigs">Gigs</a> </li>
                            <li> <a onclick='<?php $cat = "Resume"; ?>'    href="sampleCat.php?cat=resume">Resume</a> </li>
                            <!--<?php $_SESSION['varname'] = $cat; ?>-->
                        </ul>
                    </li>
        ...
        <div id= "container4">
            <div id = "Contact" style="s-index:-1;color:black">
                <div id = "ContactUs" style="s-index:-1;align-content: center; color:black;top:0px">
                        <div style=" font-size: 40px;color: white;text-align: center; font-family: Impact">
                            ...
                            <br/><br/>
                        <div class="button">
                            <a style="font-size: 20px" href="https://accounts.google.com/ServiceLogin/identifier?flowName=GlifWebSignIn&flowEntry=AddSession">
                                Email&nbsp;Us&nbsp;Now
            ...
            <ul id="footer_Nav" style="s-index:1000;color:black">
                ...
                <li id = "TNav"><a href="CLAboutUs.html">About Us</a></li>
                <li id = "FNav"><a class="active" href="craigslist.html">Home</a></li>
